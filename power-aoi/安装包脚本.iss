...
AppId={{07E6669B-97DC-497D-8514-549705D41508}
AppName={#MyAppName}
...
[Files]
Source: "D:\power-aoi-csharp\power-aoi\bin\Release\检验端.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "D:\power-aoi-csharp\power-aoi\bin\Release\检验端.exe.config"; DestDir: "{app}"; Flags: ignoreversion
